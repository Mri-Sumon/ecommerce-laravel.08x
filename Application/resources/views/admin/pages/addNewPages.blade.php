            ...
            <div class="col-lg-10 mx-auto">
				<div class="card">
					...
					<div class="card-body p-4">
                        ...
                        <form action="{{URL::to('/')}}/pages" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            
							<div class="row mb-3">
								<label for="pageName" class="col-sm-3 col-form-label">Page Name</label>
								<div class="col-sm-9">
									<input id="pageName" type="text" value="" name="pageName" class="form-control" placeholder="Page name write here">
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									<input id="pageTitle" type="text" value="" name="pageTitle" class="form-control" placeholder="Page title write here">
								</div>
							</div>
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9">
									<input id="pageLinks" type="text" value="" name="pageLinks" class="form-control" placeholder="Page Link">
								</div>
							</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9" style="padding-right: 15px">
                                    ...
                                    @enderror
                                    <textarea name="pageBody" id="tinyMceFull-2" placeholder="Write page body here..."></textarea>
                                </div>
							</div>
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9">
									<input id="sorts" type="number" value="" name="sorts" class="form-control" placeholder="Sort">
								</div>
							</div>
