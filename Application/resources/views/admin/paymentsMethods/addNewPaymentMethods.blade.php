...
@section('title') {{'Add New Payment Methods'}} @endsection
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-end addNewProducts">
				<a href="{{URL::to('/')}}/paymentsMethods" class="btn btn-sm" tabindex="-1" style="background-color: #2E4F6B; padding: 5px; color: white;">All Payment Methods</a>
            </div>
        </div> 
		<hr/>
            ...
            <div class="col-lg-10 mx-auto">
				<div class="card">
					...
					<div class="card-body p-4">
                        ...
                        <form action="{{URL::to('/')}}/paymentsMethods" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
								...
								<div class="col-sm-9">
                                    <div class="row">
										<div class="col-6">
                                            ...
                                            @enderror
											<input id="transactionNumber" type="number" value="" name="transactionNumber" class="form-control" placeholder="Add transaction number">
										</div>
										<div class="col-6">
                                            @error('logo')
                                                <div class="alert alert-danger mt-2">{{$message}}</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
                                    @error('operatorName')
                                        <div class="alert alert-danger mt-2">{{$message}}</div>
                                    @enderror
									<input id="operatorName" type="text" value="" name="operatorName" class="form-control" placeholder="Add operator name">
								</div>
							</div>
