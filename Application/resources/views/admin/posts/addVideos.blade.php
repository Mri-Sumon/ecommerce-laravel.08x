...
@section('title') {{'Add Section body (Videos)'}} @endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="my-3 mx-3">
                                <form action="{{URL::to('/')}}/addVideos" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf

                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Add Videos</label>
                                        <div class="col-sm-9">
                                            @error('videos')
                                                <div class="alert alert-danger">{{$message}}</div>
                                            @enderror
                                            <input id="videos" type="text" value="" name="videos" class="form-control">
                                        </div>
                                    </div>
